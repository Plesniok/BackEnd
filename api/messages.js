const MessagesInstance = require('../service/messagesService')
...
class ConversationsApi{
    async getMessages (req, res) {
        ...
        if(req.validationError){
            ...
            [statusCode, errorCode,errorMessage, resMessage] = await MessagesInstance.getMessages(req.query)
        }
        let resBody = {
    ...
    async getUser (req, res) {
        ...
        if(req.validationError){
            ...
            [statusCode, errorCode,errorMessage, resMessage] = await MessagesInstance.getUser(req.query)
        }
        let resBody = {
            statusCode: statusCode,
            errorCode: errorCode,
